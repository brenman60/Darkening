...
{
    [MenuItem("GameObject/UI/Darkening Button", false, 10)]
    private static void CreateForlornUIButton(MenuCommand menuCommand)
    {
        GameObject customButtonObj = new GameObject("Darkening Button");
        ...
        customButtonObj.AddComponent<DarkeningButton>();
